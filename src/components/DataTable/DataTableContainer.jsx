...
import { initialInvoices } from './InvoiceUtils.ts';

const DataTableContainer = ({ endpoint, columns, initialPageSize = 10 }) => {
  // Context and state
  ...
  const fetchInvoices = useCallback(async () => {
    try {
      ...
      // Process invoices
      const processedInvoices = initialInvoices.map(invoice => ({
        ...invoice,
